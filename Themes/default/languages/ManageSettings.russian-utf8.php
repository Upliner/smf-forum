...
$txt['globalCookies'] = 'Использовать кросс-доменные cookies<div class="smalltext">(сначала отключите локальное хранение cookies!)</div>';
...
$txt['image_proxy_enabled_desc'] = 'Проксировать изображения вставленные через тег <b>[img]</b>.';
$txt['image_proxy_secret'] = 'Секретный код для проксирования изображений';
$txt['image_proxy_secret_desc'] = 'Должен быть уникальный для каждого форума. Сохраняйте в секрете.';
$txt['image_proxy_maxsize'] = 'Максимальный размер изображений которые будут сохранены в кэше';
$txt['image_proxy_maxsize_postinput'] = 'Кб';
$txt['image_proxy_maxsize_desc'] = 'Изображения большего размера, все равно, будут отображаться.';
