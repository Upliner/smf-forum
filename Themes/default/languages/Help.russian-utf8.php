...
$helptxt['image_proxy_enabled'] = 'Включение прокси для изображений';
$helptxt['image_proxy_secret'] = 'Сохранение этого кода в секрете защищает форум от вставки ваших изображений на чужих сайтах. Измените его, чтобы сделать текущие чужие вставки нерабочими.';
$helptxt['image_proxy_maxsize'] = 'Максимальный размер изображения, который будет кешироваться прокси: изображения большего размера не будут кэшироваться. Кэшированные изображения хранятся в папке кэша SMF, поэтому убедитесь, что у вас достаточно свободного места.';
