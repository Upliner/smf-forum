...
$txt['install_step_databaseset'] = 'Настройки базы данных';
...
$txt['congratulations_help'] = 'При возникновении любых проблем, связанных с работой форума, не забывайте про <a href="http://www.simplemachines.org/community/index.php" target="_blank">официальный сайт поддержки</a>.';
$txt['still_writable'] = 'Директория установки имеет права на запись. В целях безопасности рекомендуется сделать её доступной только для чтения.';
$txt['delete_installer'] = 'Нажмите сюда, чтобы удалить install.php';
$txt['delete_installer_maybe'] = '<em>(работает не на всех серверах).</em>';
$txt['go_to_your_forum'] = 'Теперь можно перейти на установленный <a href="%1$s">форум</a>. После авторизации будет доступен раздел администрирования.';
$txt['good_luck'] = 'Удачи!<br />SimpleMachines';

$txt['install_welcome'] = 'Добро пожаловать';
$txt['install_welcome_desc'] = 'Добро пожаловать в SMF. Этот скрипт проведет вас через процесс установки %1$s. В течение нескольких следующих шагов потребуется указать некоторые детали, необходимые для установки, после чего форум будет готов к использованию.';
...
$txt['user_refresh_install'] = 'Форум обновлен';
$txt['user_refresh_install_desc'] = 'Во время установки инсталлятор обнаружил, что одна или несколько таблиц, которые должны быть созданы в базе данных, уже существуют.<br />Эти таблицы были заполнены данными по умолчанию. Данные, уже содержащиеся в таблицах, сохранены.';

$txt['default_topic_subject'] = 'Добро пожаловать в SMF!';
$txt['default_topic_message'] = 'Добро пожаловать на форум SimpleMachines!<br /><br />При возникновении каких-либо проблем с работой форума, пожалуйста, обращайтесь на [url=http://www.simplemachines.org/community/index.php]официальный сайт поддержки[/url].<br />Вы также можете посетить [url=http://www.simplemachines.ru/index.php]русскоязычное сообщество SMF[/url].<br /><br />Большое спасибо!<br />SimpleMachines';
...
$txt['error_message_bad_try_again'] = 'продолжить установку <em>не смотря ни на что</em> (Не рекомендуется).';
...
$txt['install_settings_url_info'] = 'Адрес (URL) форума указывается <strong>без \'/\'</strong> в конце.<br />Программа установки автоматически определила адрес. При желании его можно изменить.';
...
$txt['install_settings_compress_info'] = 'Эта функция работает не на всех серверах.<br />Нажмите <a href="install.php?obgz=1&amp;pass_string=PASS" onclick="return reqWin(this.href, 200, 60);" target="_blank">сюда</a> для проверки вашего сервера. (Если сжатие поддерживается сервером, появится слово "PASS".)';
...
$txt['install_settings_utf8_info'] = 'Эта функция позволяет базе данных и форуму использовать международную кодировку UTF-8. Это удобно при работе с несколькими языками, использующими разные кодировки.';
...
$txt['db_settings_username_info'] = 'Введите имя пользователя для подключения к базе данных. <br />Если не знаете его, попробуйте ввести логин от своего FTP-аккаунта, обычно они идентичны.';
...
$txt['db_settings_prefix_info'] = 'Префикс для каждой таблицы в базе данных.  <strong>Не устанавливайте два форума с одним и тем же префиксом!</strong><br /> Позволяет устанавливать несколько форумов в одну базу данных.';
...
$txt['user_settings'] = 'Создание учетной записи';
...
$txt['user_settings_email'] = 'E-mail';
$txt['user_settings_email_info'] = 'Введите ваш электронный адрес.  <strong>Он должен быть действительным.</strong>';
$txt['user_settings_database'] = 'Пароль к базе данных';
$txt['user_settings_database_info'] = 'В целях безопасности, для создания учетной записи администратора, требуется ввести пароль к базе данных.';
$txt['user_settings_skip'] = 'Пропустить';
$txt['user_settings_skip_sure'] = 'Уверены, что хотите пропустить создание учётной записи администратора?';
...
$txt['ftp_path_info'] = 'Это <em>относительный</em> путь, используемый вашим FTP сервером.';
...
$txt['error_php_too_low'] = 'Внимание! Для нормальной работы SMF <strong>требуется более новая версия PHP</strong>. <br />Если пользуетесь услугами хостинга, обратитесь к хостеру с просьбой обновить версию PHP. Установку форума можно продолжить, но могут возникнуть проблемы.<br />Это НЕ рекомендуется.';
$txt['error_missing_files'] = 'Программе установки не хватает некоторых файлов!<br /><br />Пожалуйста, удостоверьтесь в том, что загрузили на сервер все файлы.';
$txt['error_session_save_path'] = 'Пожалуйста, оповестите вашего хостера о том, что <strong>session.save_path указанный в php.ini</strong> неверный!  Путь необходимо изменить на <strong>существующую</strong> директорию, которая <strong>имеет права на запись</strong>.<br />';
$txt['error_windows_chmod'] = 'Вы используете сервер на базе Windows, и некоторые файлы не имеют прав на запись. Пожалуйста, обратитесь к вашему хостеру, с просьбой дать <strong>права на запись</strong>, пользователю, под которым работает PHP. Следующие файлы и папки должны иметь права на запись:';
...
$txt['error_db_too_low'] = 'Версия используемого сервера баз данных очень старая и не отвечает минимальным требованиям SMF.<br /><br />Пожалуйста, попросите своего хостера обновить или сменить её на более новую. В случае отказа попробуйте другой хостинг.';
$txt['error_db_database'] = 'Программа установки не может получить доступ  &quot;<em>%1$s</em>&quot; к базе данных.  На некоторых хостингах базу данных нужно создавать через панель администрирования, прежде чем SMF сможет использовать её. На некоторых добавляется префикс к базе данных, например, имя пользователя.';
...
$txt['error_session_missing'] = 'Программа установки не смогла определить поддержку сессий в PHP на вашем сервере.  Пожалуйста, удостоверьтесь в том, что PHP установлен с поддержкой сессий.';
...
$txt['error_subs_missing'] = 'Отсутствует файл Sources/Subs.php. Пожалуйста, удостоверьтесь в том, что загрузили на сервер все файлы.';
$txt['error_db_alter_priv'] = 'Учетная запись базы аккаунта не имеет следующих прав доступа ALTER, CREATE, и/или DROP в базе данных; это важно для правильной работы SMF.';
$txt['error_versions_do_not_match'] = 'Программа установки обнаружила другую установленную версию SMF. Если хотите обновить установленную версию, воспользуйтесь программой обновления (upgrade.php).<br /><br />';
...
$txt['error_mod_security_no_write'] = 'Программа установки обнаружила установленный модуль mod_security. Этот модуль будет блокировать передающиеся формой данные. SMF форум имеет встроенный сканер безопасности, который превосходит по возможностям этот модуль и работает намного эффективней.<br /><br /><a href="http://www.simplemachines.org/redirect/mod_security">Как отключить mod_security</a>';
...
$txt['error_valid_email_needed'] = 'Вы ввели неверный e-mail.';
$txt['error_already_installed'] = 'Программа установки обнаружила, что SMF уже установлен. Настоятельно <strong>не</strong> рекомендуется пытаться перезаписать установленный форум. Продолжение установки <strong>может привести к потере или повреждению имеющихся данных</strong>.<br /><br />Если всё-таки хотите произвести обновление, пожалуйста, посетите сайт <a href="http://www.simplemachines.org">Simple Machines</a> и загрузите последний пакет <em>обновления</em>. <br /><br />Если хотите перезаписать установленный форум, включая все данные, то рекомендуется удалить таблицы форума из существующей базы данных, удалить Settings.php и повторить попытку установки.';
$txt['error_warning_notice'] = 'Предупреждение!';
$txt['error_script_outdated'] = 'Программа установки устарела! Последняя версия SMF: %1$s, а ваша программа установки для %2$s.<br /><br />Рекомендуется посетить сайт <a href="http://www.simplemachines.org">Simple Machines</a> чтобы удостовериться, что устанавливается самая последняя версия.';
$txt['error_db_filename'] = 'Необходимо ввести имя файла для базы данных SQLite.';
...
$txt['error_db_filename_exists'] = 'База данных, которую пытаетесь создать, уже существует. Пожалуйста, удалите существующий файл базы данных или введите другое имя.';
$txt['error_db_prefix_reserved'] = 'Указанный префикс является зарезервированным. Пожалуйста, введите другой.';
...
$txt['upgrade_paused_overload'] = 'Обновление было приостановлено, чтобы избежать перегрузки вашего сервера. Чтобы продолжить, нажмите <label for="contbutt">Продолжить</label> внизу.';

$txt['upgrade_ready_proceed'] = 'Благодарим за выбор в пользу обновления до SMF %1$s. Все требуемые файлы на своем месте, можно приступать.';

$txt['upgrade_error_script_js'] = 'Программа обновления не может найти script.js, либо он устарел. Убедитесь, что настройки путей для вашей темы оформления указаны правильно. Можно загрузить утилиту repair_settings для проверки настроек с сайта <a href="http://www.simplemachines.org">Simple Machines</a>.';
...
$txt['upgrade_warning_out_of_date'] = 'Программа обновления устарела! Последняя версия SMF: <em id="smfVersion" style="white-space: nowrap;">??</em>, а ваша программа обновления для <em id="yourVersion" style="white-space: nowrap;">%1$s</em>.<br /><br />Рекомендуется посетить сайт <a href="http://www.simplemachines.org">Simple Machines</a>, чтобы удостовериться, что обновляетесь на последнюю версию.';
